...
import { ArrowRight, CheckCircle2, Wind, Shield } from 'lucide-react';
...
export const ClimatizacionSection: React.FC<ServiceSectionProps> = ({ onOpenQuote }) => {
  const data = SERVICES_DATA.climatizacion;

  return (
    <section id="climatizacion" className="py-20 lg:py-28 bg-white border-b border-slate-200/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="pt-2">
              <button
                onClick={() => onOpenQuote('climatizacion')}
                ...
                id="cta-consultar-climatizacion"
              >
